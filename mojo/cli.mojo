...
def main():
    ...
    print(
        "ReleaseMade requires human certification:",
        requires_human_certification("ReleaseMade"),
    )
    print(
        "Agent can certify ReleaseMade:", can_agent_certify_event("ReleaseMade")
    )
    ...
    print(
        "Action high-risk requires review:",
        action_requires_review("high", False),
    )
    print(
        "Received -> Searching forward:",
        is_forward_transition("Received", "Searching"),
    )
