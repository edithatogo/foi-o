...
The normalized cross-jurisdiction register is
`source-rights-evidence-register.yaml`. It is a candidate register only: its
statuses do not establish source authority, content rights, runtime activation,
or empirical eligibility.
