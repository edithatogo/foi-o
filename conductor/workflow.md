...
If Mojo/MAX, Pixi, or optional external services are unavailable, record the exact unavailable external gate separately from repo-local Python proof.

## Autonomous Comprehensive Execution Schema

Generated and updated Conductor plans must be executed autonomously until all listed tracks are complete, a bounded retry blocker is reached, or an unrecoverable design decision requires user input.
...
- Continue to the next listed track after archive unless a bounded retry blocker or unrecoverable design decision is reached.
