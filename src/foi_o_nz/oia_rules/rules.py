    ...
    if receipt_date.valueState == "not_provided":
        ...
        return RuleResult(
            ...
            trace_step={
                ...
                "parameterVersions": [
                    {"id": "nz-oia/parameter.working_day_limit", "effectiveFrom": "2025-04-05"}
                ],
...
def evaluate_transfer_deadline(
    ...
    return RuleResult(
        ...
        trace_step={
            ...
            "inputsUsed": ["nz-oia/variable.receipt_date"],
            "parameterVersions": [
                {"id": "nz-oia/parameter.transfer_limit", "effectiveFrom": "2025-04-05"}
            ],
            "result": {"value": due_str, "valueState": "known"},
...
def evaluate_extension_validity(
    ...
    if (
        ...
        or extension_notice_date.valueState != "known"
        or not extension_notice_date.value
        or extension_ground.valueState != "known"
        or extension_ground.value is None
        or extension_period_working_days.valueState != "known"
        or extension_period_working_days.value is None
    ):
        return RuleResult(
            outputs={
                "nz-oia/decision.extension_validity": ValueObject(value=None, valueState="unknown")
            },
            trace_step={},
        )
    ...
    val = ValueObject(
        value=True,
        valueState="known",
        warnings=["extension period reasonableness requires human review"],
    )
...
def evaluate_deemed_refusal(
    ...
    if (
        receipt_date.valueState != "known"
        or not receipt_date.value
        or current_date.valueState != "known"
        or not current_date.value
        or response_sent.valueState != "known"
        or response_sent.value is None
    ):
        return RuleResult(
            outputs={
                "nz-oia/decision.deemed_refusal": ValueObject(value=None, valueState="unknown")
            },
            trace_step={},
        )
    ...
    if response_sent.value is True:
        ...
        return RuleResult(
            ...
            trace_step={
                ...
                "inputsUsed": [
                    "nz-oia/variable.receipt_date",
                    "nz-oia/variable.current_date",
                    "nz-oia/variable.response_sent",
                ],
                "parameterVersions": [],
...
def evaluate_invocation(
    ...
    if dec_id == "nz-oia/decision.response_deadline":
        receipt = inputs.get("nz-oia/variable.receipt_date") or ValueObject(
            valueState="not_provided"
        )
    ...
    if dec_id == "nz-oia/decision.extension_validity":
        ...
        notice = inputs.get("nz-oia/variable.extension_notice_date") or ValueObject(
            valueState="not_provided"
        )
        ground = inputs.get("nz-oia/variable.extension_ground") or ValueObject(
            valueState="not_provided"
        )
        period = inputs.get("nz-oia/variable.extension_period_working_days") or ValueObject(
            valueState="not_provided"
        )
    ...
    if dec_id == "nz-oia/decision.deemed_refusal":
        ...
        current = inputs.get("nz-oia/variable.current_date") or ValueObject(
            valueState="not_provided"
        )
    ...
    if dec_id == "nz-oia/decision.urgency_flag":
        reasons = inputs.get("nz-oia/variable.urgency_reasons_provided") or ValueObject(
            valueState="not_provided"
        )
