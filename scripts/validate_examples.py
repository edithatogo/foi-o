...
PAIR_GLOBS = [
    ...
    ("empirical-taskset-manifest*.json", "empirical-taskset-manifest.schema.json"),
    ...
    ("repository-release-metadata*.json", "repository-release-metadata.schema.json"),
    ("release-checklist*.json", "release-checklist.schema.json"),
    ("publication-panel-scorecard*.json", "publication-panel-scorecard.schema.json"),
    ...
    ("generated-asset-manifest*.json", "generated-asset-manifest.schema.json"),
    ("maturation-summary*.json", "maturation-summary.schema.json"),
    ("process-model-conformance*.json", "process-model-conformance.schema.json"),
    ("process-mining-conformance*.json", "process-mining-conformance.schema.json"),
    ("process-mining*.ocel.json", "process-mining-ocel.schema.json"),
    ("arxiv-readiness*.json", "arxiv-readiness.schema.json"),
    ("submission-latex-pipeline*.json", "submission-latex-pipeline.schema.json"),
