...
def _generate_sample_bronze_records(
    ...
    jurisdictions_data = [
        ...
        (
            ...
            "FOIA",
            "Cabinet Office",
            "Cabinet Office request for ministerial meeting minutes. Full grant of access released in full.",
            "2026-01-05",
            "2026-01-25",
        ),
        (
            ...
            "EIR",
            "Environment Agency",
            "Environment Agency river water quality monitoring datasets. Disclosed in full under EIR regulations.",
            "2026-02-01",
            "2026-02-18",
        ),
        (
            ...
            "FOISA",
            "Scottish Government",
            "Scottish Government renewable energy subsidies review. Released in part with section 33 redactions.",
            "2026-03-01",
            "2026-03-22",
        ),
        (
            ...
            "European Commission",
            "European Commission DG TRADE negotiation briefing. Partially released under Art 4(2) exceptions.",
            "2026-04-01",
            "2026-04-16",
        ),
        (
            ...
            "Department of Public Expenditure capital infrastructure allocation. Granted in full.",
            "2026-05-01",
            "2026-05-19",
        ),
        (
            ...
            "TBS Canada IT modernisation roadmap. Released in part with s19 and s21 exemptions.",
            "2026-06-01",
            "2026-06-28",
        ),
        (
            ...
            "Department of Energy grid resilience modeling report. Access granted in full.",
            "2026-07-01",
            "2026-07-22",
        ),
        (
            ...
            "DFFE South Africa fisheries quota allocation report. Released in full under PAIA.",
            "2026-08-01",
            "2026-08-26",
        ),
        (
            ...
            "BMDV Breitbandausbau Gutachten. Auskunft erteilt und vollständig zugänglich gemacht.",
            "2026-09-01",
            "2026-09-24",
        ),
        (
            "Spain/Tu Derecho a Saber",
            "LTA",
            "Ministerio de Hacienda y Función Pública",
            "Ministerio de Hacienda ejecución presupuestaria. Acceso concedido y entregado.",
            "2026-10-01",
            "2026-10-22",
        ),
        (
            ...
            "Ministère de la Transition écologique rapports d'inspection. Accès accordé et documents communiqués.",
            "2026-11-01",
            "2026-11-25",
        ),
        (
            ...
            "TF",
            "Finansdepartementet",
            "Finansdepartementet makroekonomisk prognos. Allmän handling utlämnad skyndsamt.",
            "2026-12-01",
            "2026-12-03",
        ),
        (
            ...
            "BZK adviesrapport woningbouwimpuls. Informatie geheel verstrekt onder Wet open overheid.",
            "2026-01-10",
            "2026-02-02",
        ),
        (
            ...
            "MinTIC conectividad rural. Solicitud recibida y en trámite.",
            "2026-02-01",
            "2026-02-09",
        ),
    ]
