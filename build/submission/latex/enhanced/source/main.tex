...
packaging constraints. These checks provide repo-local proof that the
current package is internally consistent. They do not prove that every
public request platform has been ingested, that all New Zealand agencies
are represented, or that the model has been validated across other
jurisdictions. Instead, they define a smaller and more defensible
