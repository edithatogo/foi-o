...
| NSW empirical frame, codebook, packets, metrics, maturity | [AU-NSW bounded maturity promotion](82-au-nsw-bounded-maturity-promotion-outcome-2026-07-27.md); decision artifact `examples/v2/au-nsw-maturity-decision.approved.json` | Mature only within approved ontology and bounded v3 evidence scope | No gold promotion, population inference, publication, or release |
