...
| Read-only capture and archive infrastructure | `fyi-archive` commits `91eef8b`, `44e2587`, `b2eb327`, `e84b559`, `292a757` | Registry-driven, paginated, hash-recording IA acquisition implemented | Dispatch remains read-only; rights gate precedes empirical use |
...
probe returned empty arrays. Empty or capped Internet Archive results are
retained as negative evidence and cannot become source populations, immutable
empirical manifests, annotation inputs, or maturity evidence.
